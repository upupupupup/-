...
# from VGGNetV8 import VGG11ResNet
...
class Trainer:
    def __init__(self):
        ...
        self.opt = torch.optim.SGD(net.parameters(), lr=0.0001)
        self.writer = SummaryWriter("logsv9")
    ...
    def test(self, epoch):
        ...
        if test_avg_acc > 0.8:
            torch.save(self.net.state_dict(), f"weightsv9/{epoch}_{test_avg_acc}.pt")
