...
from VGGNetV5 import VGG16  # V4:VGG16 + SGD(lr=0.001）+ BN+ bias=False
...
class Trainer:
    def __init__(self):
        ...
        self.writer = SummaryWriter("logsv5")
    ...
    def test(self, epoch):
        ...
        if test_avg_acc > 0.88:
            torch.save(self.net.state_dict(), f"weights1/{epoch}_{test_avg_acc}.pt")
