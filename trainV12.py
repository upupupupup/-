...
class Trainer:
    def __init__(self):
        ...
        self.writer = SummaryWriter("logsv12")
    ...
    def test(self, epoch):
        ...
        if test_avg_acc > 0.8:
            torch.save(self.net.state_dict(), f"weightsv12/{epoch}_{test_avg_acc}.pt")
